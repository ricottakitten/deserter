...
local initialize = function()
    ...
    skill_engage:set_skill_properties(1.2, 20) -- 100% of base damage, 20 frames cooldown
    ...
    state_raspberry:onStep(function(actor, data)
        ...
        if data.fired == 0 and actor.image_index >= 1.0 then
            ...
            if actor:get_active_skill(Skill.SLOT.primary).stock >= 1 then
                ...
                actor.pVspeed = actor.pHmax * -4
                actor.pHspeed = GM.cos(GM.degtorad(actor:skill_util_facing_direction())) * actor.pHmax * 4
            end
        end
